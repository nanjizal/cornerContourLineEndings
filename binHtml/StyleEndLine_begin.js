...
cornerContourWebGLTest_CornerContourWebGL.prototype = {
	rearrageDrawData: function() {
		haxe_Log.trace("rearrangeDrawData",{ fileName : "src/cornerContourWebGLTest/CornerContourWebGL.js.hx", lineNumber : 229, className : "cornerContourWebGLTest.CornerContourWebGL", methodName : "rearrageDrawData"});
		var pen = this.pen2D;
		var data = pen.arr;
		var red = 0.;
		var green = 0.;
	...
	,drawContours: function() {
		...
		this.pen2D = new cornerContour_Pen2D(-16777216);
	...
	,turtleTest0: function(x,y) {
		var sketcher = new cornerContour_Sketcher(this.pen2D,4,this.styleEnd);

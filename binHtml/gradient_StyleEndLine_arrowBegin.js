...
cornerContour_Contour.prototype = {
	...
	,triangleJoin: function(ax_,ay_,bx_,by_,width_,curveEnds,overlap) {
		...
		if(this.count == 0 && (this.endLine == 1 || this.endLine == 3 || this.endLine == 6 || this.endLine == 8 || this.endLine == 11 || this.endLine == 9 || this.endLine == 15 || this.endLine == 17 || this.endLine == 12 || this.endLine == 14)) {
			var ax = this.ax;
			var ay = this.ay;
	...
	,end: function(width_) {
		this.endEdges();
		if(this.count != 0 && (this.endLine == 2 || this.endLine == 3 || this.endLine == 7 || this.endLine == 8 || this.endLine == 11 || this.endLine == 10 || this.endLine == 16 || this.endLine == 17 || this.endLine == 13 || this.endLine == 14)) {
			var ax = this.bx;
			var ay = this.by;
			var beta = -this.angle1 - Math.PI / 2;
			var gamma = -this.angle1 - Math.PI / 2 - Math.PI;
				...
				if(this.endLine == 11 || this.endLine == 10) {
					...
					if(this1 == 7 || this1 == 8) {
						...
						if(this1 == 16 || this1 == 17) {
							...
							this.pen.triangle2DFill(fx,fy,cx,cy,dx,dy,color_);
							var color_ = color;
							if(color_ == null) {
								color_ = -1;
							}
							this.pen.triangle2DFill(fx,fy,dx,dy,ex,ey,color_);
						}
					}
				}
				totalSteps += 2;
...
cornerContourWebGLTest_CornerContourWebGL.prototype = {
	rearrageDrawData: function() {
		haxe_Log.trace("rearrangeDrawData",{ fileName : "src/cornerContourWebGLTest/CornerContourWebGL.js.hx", lineNumber : 136, className : "cornerContourWebGLTest.CornerContourWebGL", methodName : "rearrageDrawData"});
		var pen = this.pen2D;
		var data = pen.arr;
		var redA = 0.;
		var greenA = 0.;
		...
		this.arr32 = this1;
		haxe_Log.trace("total triangles " + this.len,{ fileName : "src/cornerContourWebGLTest/CornerContourWebGL.js.hx", lineNumber : 162, className : "cornerContourWebGLTest.CornerContourWebGL", methodName : "rearrageDrawData"});
		var _g = 0;
	...
	,drawContours: function() {
		haxe_Log.trace("drawContours",{ fileName : "src/cornerContourWebGLTest/CornerContourWebGL.js.hx", lineNumber : 293, className : "cornerContourWebGLTest.CornerContourWebGL", methodName : "drawContours"});
	...
	,renderOnce: function() {
		haxe_Log.trace("renderOnce",{ fileName : "src/cornerContourWebGLTest/CornerContourWebGL.js.hx", lineNumber : 383, className : "cornerContourWebGLTest.CornerContourWebGL", methodName : "renderOnce"});
	...
	,turtleTest0: function(x,y) {
		...
		if(sketcher.repeatCommands) {
			...
			case 0:case 1:case 6:case 9:case 12:case 15:
				tmp = false;
				break;
			case 2:case 3:case 4:case 5:case 7:case 8:case 10:case 11:case 13:case 14:case 16:case 17:
				tmp = true;
				break;
			}
			if(tmp) {
